...
public class ThemXe {
	 ...
	 */
	public ThemXe(GiaoDienChinh giaoDienChinh) {
	...
	void setUpComboBox() {
		DefaultComboBoxModel trangThaiModel = new DefaultComboBoxModel();
	...
	void clearTextFields() {
		...
		tenXe_tf.setText("");
		loaiXe_tf.setText("");
		namSanXuat_tf.setText("");
		ngayNhap_tf.setText("");
		tinhTrangXe_tf.setText("");
		donGiaThue_tf.setText("");
	}
