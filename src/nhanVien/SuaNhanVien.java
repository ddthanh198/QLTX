...
public class SuaNhanVien {
	 ...
	 */
	public SuaNhanVien(GiaoDienChinh giaoDienChinh, String maNhanVienCanSua) {
		this.maNhanVienCanSua = maNhanVienCanSua;
	...
	void setTextForTextFields() throws Exception {
		NhanVien nhanVien = nhanVienDatabase.getNhanVien(maNhanVienCanSua);
		maNhanVien_tf.setText(maNhanVienCanSua);
		tenNhanVien_tf.setText(nhanVien.getTenNhanVien());
		namSinh_tf.setText(String.valueOf(nhanVien.getNamSinh()));
		viTri_tf.setText(nhanVien.getViTri());
		DT_tf.setText(nhanVien.getDT());
		email_tf.setText(nhanVien.getEmail());
