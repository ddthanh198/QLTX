...
public class SuaKhachHang {
	...
	private DefaultComboBoxModel gioiTinhModel;
	 ...
	 */
	public SuaKhachHang(GiaoDienChinh giaoDienChinh, String maKhachHangCanSua) {
		this.maKhachHangCanSua = maKhachHangCanSua;
	...
	void setTextForTextFields() throws Exception {
		KhachHang khachHang = khachHangDatabase.getKhachHang(maKhachHangCanSua);
		maKhachHang_tf.setText(maKhachHangCanSua);
		tenKhachHang_tf.setText(khachHang.getTenKhachHang());
		namSinh_tf.setText(String.valueOf(khachHang.getNamSinh()));
		CMND_tf.setText(khachHang.getCMND());
		DT_tf.setText(khachHang.getDT());
		email_tf.setText(khachHang.getEmail());
		diaChi_tf.setText(khachHang.getDiaChi());
	}
	
	void setUpComboBox() {
		gioiTinhModel = new DefaultComboBoxModel();
	...
	void setSelectedItemForComboBox() throws Exception {
		...
		gioiTinhModel.setSelectedItem(gioiTinh);
	}
	...
	void suaBtnPressed() throws Exception {
		...
		khachHangDatabase.suaKhachHang(khachHangMoi, maKhachHangCanSua);
	}
