...
public class ThemThueXe {
	 ...
	 */
	public ThemThueXe(GiaoDienChinh giaoDienChinh) {
	...
	void setUpButtons() {
		...
		themBtn.setBounds(312, 418, 220, 100);
	...
	void themBtnPressed() throws Exception {
		...
		thueXeDatabase.themThueXe(thueXeMoi);
	}
